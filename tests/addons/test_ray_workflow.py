...
from functionfuse.backends.plugins import (
    PluginCollection,
    InitializerPlugin,
    RandomStatePlugin,
)
...
storage = "file:" + os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "workflow_storage"
)
